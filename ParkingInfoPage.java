...
public class ParkingInfoPage extends JFrame {
    ...
    //  setUndecorated(true);
      ...
      pass.setText("Parking Pass Info");

      e.setFont(font);
      e.setForeground(new Color(0,90,139));
      back.setFont(font);
      back.setForeground(new Color(0,90,139));
      pass.setFont(font);
      pass.setForeground(new Color(0,90,139));
       
      e.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
          shuttleButtonActionPerformed();
        }
      }); 
      ...
      pass.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
          parkingPassButtonActionPerformed();
        }
      });  
      ...
      addComponentsToPane(panel, pass);
    ...
    private static void setParkingIcon(JButton b,double x,final int y){
     ...
     if(x ==  0){
       ...
       if (x <= (y * 0.75)) { 
        ImageIcon img4 = new ImageIcon("0%.png"); 
        b.setIcon(img4);
       } else { b.setIcon(new ImageIcon("100%.png")); }
     }
  ...
  private  void shuttleButtonActionPerformed() {
    ShuttleInfo s = new ShuttleInfo();
    dispose(); 
  } 
  ...
  private  void backButtonActionPerformed() {
    ...
    private  void parkingPassButtonActionPerformed() {
